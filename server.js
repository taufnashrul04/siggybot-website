...
// ============================================================
// KEYWORD & MODE DETECTION — Same as Discord Bot
// ============================================================
...
// ============================================================
// KNOWLEDGE FINDER — Same as Discord Bot
// ============================================================
...
// ============================================================
// SYSTEM PROMPTS — Same as Discord Bot
// ============================================================
...
// ============================================================
// API CALL — Jatevo (Same as Discord Bot)
// ============================================================
...
// ============================================================
app.listen(PORT, () => {
  console.log(`\n✅ SiggyBot Website Server running at http://localhost:${PORT}`);
  console.log("🐱 Siggy AI is ready to chat on the web!");
  console.log("🔮 Dual mode: Chaos & Ritual activated");
